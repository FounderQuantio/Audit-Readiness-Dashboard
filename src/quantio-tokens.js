...
export const COLORS = {
  ...
  goldTint1:      "rgba(91,127,166,0.12)",
  goldTint2:      "rgba(91,127,166,0.08)",
  goldTint3:      "rgba(91,127,166,0.05)",
  goldBorder:     "rgba(91,127,166,0.28)",
...
export const SHADOW = {
  ...
  lg:   "0 20px 48px rgba(15,23,42,0.14), 0 8px 16px rgba(15,23,42,0.08)",
  gold: "0 0 0 1px rgba(91,127,166,0.20), 0 20px 48px rgba(15,23,42,0.14)",
};
