...
export const COLORS = {
  ...
  goldTint1:      "rgba(100,149,237,0.12)",
  goldTint2:      "rgba(100,149,237,0.08)",
  goldTint3:      "rgba(100,149,237,0.05)",
  goldBorder:     "rgba(100,149,237,0.28)",
...
export const SHADOW = {
  ...
  lg:   "0 20px 48px rgba(33,36,39,0.14), 0 8px 16px rgba(33,36,39,0.08)",
  gold: "0 0 0 1px rgba(100,149,237,0.20), 0 20px 48px rgba(33,36,39,0.14)",
};
